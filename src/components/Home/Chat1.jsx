          ...
          <div className="max-w-4xl mx-auto w-full p-4">
            ...
            <div className="flex items-center space-x-2 w-full">
              <textarea
                ...
                className="flex-1 border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#5D3FD3] focus:border-transparent bg-white shadow-xs resize-y min-h-[48px] max-h-32 break-words whitespace-pre-wrap break-all"
                value={message}
